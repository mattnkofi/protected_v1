...
import {
    ...
    LayoutDashboard, School, ShieldCheck as ShieldCheckIcon, ShieldAlert, Trophy, ActivityIcon
...
const navItems = [
    ...
    { name: 'Purple Desk', route: 'user.purple-desk', icon: ShieldAlert, color: 'text-amber-500', fill: 'fill-amber-500/20' },
